function [hit,falseAlarm,reportNum] = analysisSourcererCC_BCB_CCD(path,sim,clones,false_positives)
%ANALYSISSOURCERERCC_BCB_CCD 此处显示有关此函数的摘要
%   此处显示详细说明

[reportedClones,reportNum] = getReport_SourcererCC(path,sim);
