function [hit,falseAlarm,reportNum] = analysisCloneWorks_BCB_CCD(path,sim,functions,clones,false_positives)
%ANALYSISCLONEWORKS_BCB_CCD 此处显示有关此函数的摘要
%   此处显示详细说明

[reportedClones,reportNum] = getReport_CloneWorks(path,sim,functions);
